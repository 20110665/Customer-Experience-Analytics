    ...
    <div id="wraper">
      ...
      <div class="content">
        ...
        <div class="content1">
          ...
          <div>
            <p style="font-size: 20px; padding-right: 50px">
              Use customized dashboards to compare your performance against SLAs
              and key metrics, in real-time. Easily identify coaching
              opportunities and drive improvements in customer satisfaction.
            </p>
          </div>
          <div class="Button">
            <div class="btn-item">
      ...
      <div class="content">
        <div class="content1">
          ...
          <div>
            <p style="font-size: 20px; padding-right: 50px">
              Make data visualization easier with a powerful business
              intelligence and reporting tool. Apply flexible filtering,
              scheduling, and customization options for a 360-degree view of
              your contact center performance.
            </p>
          </div>
          <div class="Button">
            <div class="btn-item">
      ...
      <div class="content">
        ...
        <div class="content1">
          ...
          <div>
            <p style="font-size: 20px; padding-right: 50px">
              Analyze 100% of your customer interactions to find patterns in
              customer intents and sentiment. Use speech and text analytics to
              explore new opportunities to automate tasks and mitigate customer
              escalations.
            </p>
          </div>
          <div class="Button">
        ...
        <div class="content1">
          ...
          <div>
            <p style="font-size: 20px; padding-right: 50px">
              ...
              analyze, and act on customer feedback with a Voice of the Customer
              (VoC) tool. Gain the insights you need to discover trends and
              identify opportunities to place the customer at the heart of the
              contact center.
            </p>
          </div>
          <div class="Button">
      ...
      <footer class="footer">
        <div class="container-footer">
          <div class="contentfooter">
            <nav>
              <u class="footer-menu">
                <li><a href=""><h4>WHY TALKDESK</h4></a></li>
                <li><a href="">Customer service</a></li>
                <li><a href="">Sales</a></li>
                <li><a href="">Integrations</a></li>
                <li><a href="">AppConnect</a></li>
          ...
          <div class="contentfooter">
            <nav>
              <u class="footer-menu">
                <li><a href=""><h4>SOLUTIONS</h4></a></li>
                <li><a href="">Communications, Media & Internet</a></li>
                <li><a href="">Financial Services & Insurance</a></li>
                <li><a href="">Government & Education</a></li>
                <li><a href="">Healthcare & Life Sciences</a></li>
                <li><a href="">Retail & Consumer Goods</a></li>
              </u>
            </nav>
          </div>
          <div class="contentfooter">
            <nav>
              <u class="footer-menu">
                ...
                <li><a href="">Omnichannel Engagement</a></li>
                <li><a href="">Workforce Engagement</a></li>
                <li><a href="">Customer Experience Analytics</a></li>
                <li><a href="">Employee Collaboration</a></li>
              </u>
            </nav>
          </div>
          <div class="contentfooter">
            <nav>
              <u class="footer-menu">
                <li><a href=""><h4>RECOURCES</h4></a></li>
                <li><a href="">Customer service</a></li>
                <li><a href="">Sales</a></li>
